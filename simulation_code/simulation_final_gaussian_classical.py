...
l_fitting_config = ['final_gaussian_classical']
...
def setup(model_name, fitting_config):
    if fitting_config == 'final_gaussian_classical' or fitting_config == 'final_gaussian_classical_without_recurrent_connections' or fitting_config == 'final_gaussian_classical_without_recurrent_excitatory_connections':
        p_ELM = 1
        q_ELM = 0
        sigma_ELM_1 = 15
        sigma_ELM_2 = 1
    ...
    if fitting_config == 'final_gaussian_classical_linear':
    ...
    state_dict = {
        "gW": torch.tensor(
            [
                [alpha_PYR * np.sqrt(0.5996) * np.abs(opti_networks[0, 0]),
                 alpha_PYR * np.sqrt(0.5996) * np.abs(opti_networks[0, 1]),
                 alpha_PYR * np.sqrt(0.5996) * np.abs(opti_networks[0, 2]),
                 alpha_PYR * np.sqrt(0.5996) * np.abs(opti_networks[0, 3]),
                 alpha_PYR * np.sqrt(0.5996) * np.abs(opti_networks[0, 4]),
                 alpha_PYR * np.sqrt(0.5996) * np.abs(opti_networks[0, 5]),
                 alpha_PYR * np.sqrt(0.5996) * np.abs(opti_networks[0, 6]),
                 alpha_PYR * np.sqrt(0.5996) * np.abs(opti_networks[0, 7])],
                [alpha_PV * np.sqrt(1.35) * np.abs(opti_networks[1, 0]),
                 alpha_PV * np.sqrt(1.35) * np.abs(opti_networks[1, 1]),
                 alpha_PV * np.sqrt(1.35) * np.abs(opti_networks[1, 2]),
                 alpha_PV * np.sqrt(1.35) * np.abs(opti_networks[1, 3]),
                 alpha_PV * np.sqrt(1.35) * np.abs(opti_networks[1, 4]),
                 alpha_PV * np.sqrt(1.35) * np.abs(opti_networks[1, 5]),
                 alpha_PV * np.sqrt(1.35) * np.abs(opti_networks[1, 6]),
                 alpha_PV * np.sqrt(1.35) * np.abs(opti_networks[1, 7])],
                [alpha_SST * np.sqrt(0.6818) * np.abs(opti_networks[2, 0]),
                 alpha_SST * np.sqrt(0.6818) * np.abs(opti_networks[2, 1]),
                 alpha_SST * np.sqrt(0.6818) * np.abs(opti_networks[2, 2]),
                 alpha_SST * np.sqrt(0.6818) * np.abs(opti_networks[2, 3]),
                 alpha_SST * np.sqrt(0.6818) * np.abs(opti_networks[2, 4]),
                 alpha_SST * np.sqrt(0.6818) * np.abs(opti_networks[2, 5]),
                 alpha_SST * np.sqrt(0.6818) * np.abs(opti_networks[2, 6]),
                 alpha_SST * np.sqrt(0.6818) * np.abs(opti_networks[2, 7])],
                [alpha_VIP * np.sqrt(0.8437) * np.abs(opti_networks[3, 0]),
                 alpha_VIP * np.sqrt(0.8437) * np.abs(opti_networks[3, 1]),
                 alpha_VIP * np.sqrt(0.8437) * np.abs(opti_networks[3, 2]),
                 alpha_VIP * np.sqrt(0.8437) * np.abs(opti_networks[3, 3]),
                 alpha_VIP * np.sqrt(0.8437) * np.abs(opti_networks[3, 4]),
                 alpha_VIP * np.sqrt(0.8437) * np.abs(opti_networks[3, 5]),
                 alpha_VIP * np.sqrt(0.8437) * np.abs(opti_networks[3, 6]),
                 alpha_VIP * np.sqrt(0.8437) * np.abs(opti_networks[3, 7])],
